    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-16 pb-14 px-4 section-navy">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="font-heading text-4xl sm:text-5xl font-bold leading-tight mb-5">A practical delivery model for advisory, implementation, and supplier work</h1>
      ...
      <section className="py-16 px-4 section-gray">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center">
            <a href={CALENDLY_URL} target="_blank" rel="noopener noreferrer" onClick={() => trackConversion("consultation_booking_click", { location: "delivery_model" })}>
