...
const engagements = [
  ...
  ["AI Governance Program Setup", "Leadership needs a practical governance model for generative AI and enterprise AI use cases.", "Align AI inventory, policies, oversight, risk assessment, human accountability, and NIST AI RMF practices.", "AI governance charter, use case intake model, risk controls, oversight workflow.", "Governed AI adoption with clear accountability."],
