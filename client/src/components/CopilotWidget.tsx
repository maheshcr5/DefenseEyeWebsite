...
export default function CopilotWidget() {
  ...
  return (
    <div className="fixed bottom-20 right-4 z-[70] sm:bottom-20">
      {open && (
      ...
      <Button
        ...
        className="ml-auto flex rounded-md bg-primary px-4 font-semibold text-primary-foreground shadow-lg shadow-black/30 hover:bg-primary/90"
      >
